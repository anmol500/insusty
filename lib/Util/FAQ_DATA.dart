List question = [
  "🤷‍♀️ Is Insusty a non profit organisation?",
  '🌳 How can I be sure that my contribution will be used for positive environmental impact?',
  '🌻 What do you receive?',
  '💸 Where does your money go?',
  '🌍 What is a Biogas plant?',
  '💣 How can I offset my carbon footprint with Insusty?',
  '⏳ What does it mean to create an impact through sustainable consumption with Insusty?',
  '🏕️ Tell us more about the carbon offset projects Insusty works with?',
];
...
''',
  ...
  '''You can offset your carbon footprint by clicking on Discover and calculating your carbon footprint, once you submit the form you can click on Offset that will lead you to a subscription offer starting at 5.60€/month. Regardless of your carbon footprint you can choose a plan that offsets an amount lesser than, equal to or higher than your carbon footprint. Each and every contribution counts towards our fight against climate change. You can pay monthly/annually depending on which plan suits you.
Can Climate change be stopped by offsetting alone?
Carbon offsetting relies on the idea that something can be “carbon neutral” if someone pays to “cancel out” emissions by supporting a green initiative somewhere else in the world.
